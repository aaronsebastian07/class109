...
#n = any number and standard deviation for the nth height
#height_nth_std_deviation_start, height_nth_std_deviation_end = height_mean-(nth*height_std_deviation), height_mean+(nth*height_std_deviation) 
...
#n = any number and standard deviation for the nth weight
#weight_nth_std_deviation_start, weight_nth_std_deviation_end = weight_mean-(nth*weight_std_deviation), weight_mean+(nth*weight_std_deviation) 
...
#% of data is within the nth standard deviation for height
#height_list_of_data_within_nth_std_deviation = [result for result in height_list if result > height_nth_std_deviation_start and result < height_nth_std_deviation_end]
...
#% of data is within the nth standard deviation for weight
#weight_list_of_data_within_nth_std_deviation = [result for result in weight_list if result > weight_nth_std_deviation_start and result < weight_nth_std_deviation_end]
...
#printing the data for height and weight of nth standard deviation
#print("{}% of data for height lies within nth standard deviation".format(len(height_list_of_data_within_nth_std_deviation)*100.0/len(height_list)))
#print("{}% of data for weight lies within nth standard deviations".format(len(weight_list_of_data_within_nth_std_deviation)*100/len(weight_list)))